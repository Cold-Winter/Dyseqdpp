...
parser.add_argument('--cuda', action='store_true',
                    help='use CUDA')
parser.add_argument('--save', type=str,  default='./model/summe',
...
model_type = 2
data_dir = './data/'
[feature, label] = load_dataset_h5(data_dir, 'TVSum',model_type)
...
for testtime in range(10):
    ...
    try:
        ...
        for i in range(iter):
            ...
            f1scoreval = totalvalscore/10
            print 'valf1score: ',f1scoreval
            totaltestscore = 0
            for testindex in range(10,20):
